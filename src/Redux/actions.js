...
export const getDoctors = () => {
  return function (dispatch) {
    ...
    axios
      .get(`https://brainly-back.onrender.com/doctores`)
      .then((response) => {
...
export function getUsers() {
  return function (dispatch) {
    ...
    axios
      .get(`https://brainly-back.onrender.com/pacientes`)
      .then((response) => {
...
export const createPost = (postData) => {
  return (dispatch) => {
    axios
      .post("https://brainly-back.onrender.com/comentarios", postData)
      .then((response) => {
...
export const createUser = (payload) => {
  return function (dispatch) {
    ...
    axios
      .post(`https://brainly-back.onrender.com/registro`, payload)
      .then((response) => {
...
export const getComments = () => {
  return function (dispatch) {
    axios
      .get(`https://brainly-back.onrender.com/get_comments`)
      .then((response) => {
...
const getResults = () => {
  return function (dispatch) {
    axios
      .get(`https://brainly-back.onrender.com/detection/resultados`)
      .then((response) => {
        return dispatch({ type: GET_RESULTS, payload: response.data });
      })
      .catch((error) => {
        console.log(error);
      });
